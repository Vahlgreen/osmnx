...
# Define city/cities
place = "Karlslunde_landsby"
point = (55.5733495, 12.2280125) #bredde/længdegrad = lattitude/longitude

bbox= (55.5752,55.5650,12.2337,12.2149)
bbox_fig = (55.5770,55.5670,12.2339,12.2151)
...
ax.set_title('Karlslunde Landsby',loc='center',y=0.86,**title_font,**title_box,size=25,alpha=0.8)
